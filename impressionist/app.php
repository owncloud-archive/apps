...
<head>
    ...
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/jquery.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/keymaster.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/datastore.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/appui.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/fileops.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/templ.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/knobdial.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/main.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/colorpicker.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/matrices.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/raphael.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/freetransform.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/jqueryui.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/bootstrap.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/advanced.js'); ?>"
            type="text/javascript"></script>
    <script src="<?php echo OCP\Util::linkToAbsolute('impressionist', 'js/wysihtml5-0.3.0.js'); ?>"
            type="tet/javascript"></script>
    <script>
        var editor;
