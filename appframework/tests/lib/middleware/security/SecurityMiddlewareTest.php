...
class SecurityMiddlewareTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
        ...
        private function checkNavEntry($method, $shouldBeActivated=false){
                ...
                $sec->beforeController('\OCA\AppFramework\SecurityMiddlewareTest', $method);
        }
        ...
        private function ajaxExceptionCheck($method, $shouldBeAjax=false){
                ...
                try {
                        $sec->beforeController('\OCA\AppFramework\SecurityMiddlewareTest',
                                        $method);
        ...
        private function securityCheck($method, $expects, $shouldFail=false){
                ...
                if($shouldFail){
                        $this->setExpectedException('\OCA\AppFramework\SecurityException');
                }
