...
"Connect your desktop apps to ownCloud" => "Συνδέστε τις εφαρμογές των υπολογιστών σας με το ownCloud",
...
"If you like ownCloud, <a href=\"mailto:?subject=ownCloud&body=ownCloud is a great open software to sync and share your files. You can freely get it from http://owncloud.org\">recommend it to your friends</a>!" => "Εάν σας άρεσε το ownCloud, <a href=\"mailto:?subject=ownCloud&body=Το ownCloud είναι καταπληκτικό ανοιχτό λογισμικό για το συγχρονισμό και διαμοιρασμό των αρχείων σας. Μπορείτε να το λάβετε δωρεάν από την ιστοσελίδα http://owncloud.org\">συστήστε το και στους φίλους σας</a>!"
);
