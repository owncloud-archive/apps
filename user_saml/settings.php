...
$params = array('saml_ssp_path', 'saml_sp_source', 'saml_autocreate', 'saml_update_user_data', 'saml_protected_groups', 'saml_default_group', 'saml_username_mapping', 'saml_displayname_mapping', 'saml_preferredlanguage_mapping', 'saml_email_mapping', 'saml_group_mapping');
...
$tmpl->assign( 'saml_preferredlanguage_mapping', OCP\Config::getAppValue('user_saml', 'saml_preferredlanguage_mapping', 'preferredLanguage'));
