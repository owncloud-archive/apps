...
2. Edit the index.php and turn $RUNTIME_NOAPPS var to FALSE. This is require due we need that OwnCloud load the Apps the first time that the user access.
3. Access to ownCloud web with an user with admin privileges.
4. Access to the Appications pannel and enable the SAML app.
5. Access to the Administration pannel and configure the SAML app.
