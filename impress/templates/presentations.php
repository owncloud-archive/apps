...
if(empty($_['list'])) {
	...
	echo('<table class="impresslist"><thead id="impressHeader"><tr><th id="impressImg"></th><th id="impressName">'.$l->t("Name").'</th><th id="impressSize">'.$l->t("Size").'</th><th id="impressDate">'.$l->t("Date").'</th></tr></thead>');
