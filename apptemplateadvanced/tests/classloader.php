...
DEFINE('APPFRAMEWORK_CLASSPATH_DIR', '../../appframework/appinfo/classpath.php');
...
spl_autoload_register(function ($className){
	if(!loadClassPathsFrom(CLASSPATH_DIR, $className)){
		loadClassPathsFrom(APPFRAMEWORK_CLASSPATH_DIR, $className);	
	}
});


function loadClassPathsFrom($path, $className){
