...
"Sorry, but a malware was detected in a file you tried to upload and it had to be deleted." => "Συγνώμη, αλλά στο αρχείο που προσπαθήσατε να ανεβάσετε βρέθηκε επιβλαβές λογισμικό και διαγράφηκε.",
...
"File uploaded: {file}" => "Το αρχείο ανέβηκε: {file}",
...
"Stream Length" => "Μήκος της ροής δεδομένων",
"ClamAV StreamMaxLength value in bytes." => "ClamAV αξία StreamMaxLength σε bytes.",
"Path to clamscan" => "Διαδρομή για το clamscan",
"Path to clamscan executable." => "Διαδρομή για το εκτελέσιμο clamscan.",
"Not required in Daemon Mode." => "Δεν απαιτείται κατά την λειτουργία ως Υπηρεσίας.",
