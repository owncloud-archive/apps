...
"You do not have the permissions to add events to this calendar." => "Bạn không có sự cho phép thêm các sự kiện vào lịch này.",
"You do not have the permissions to edit this event." => "Bạn không có sự cho phép chỉnh sửa sự kiện này.",
"You do not have the permissions to delete this event." => "Bạn không có sự cho phép xóa sự kiện này.",
