...
<?php echo $this->inc("part.eventform"); ?>
	...
	<span id="actions">
		...
		<input type="button" class="submit" style="float: right;" id="editEvent-export"  name="export" value="<?php p($l->t("Export"));?>" data-link="<?php print_unescaped(OCP\Util::linkTo('calendar', 'export.php')) ?>?eventid=<?php echo $_['eventid'] ?>">
	</span>
	</form>
</div>
