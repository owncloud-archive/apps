...
<td width="20px">
  ...
  <a href="#" id="chooseCalendar-edit" data-id="<?php echo $_['calendar']['id'] ?>" title="<?php p($l->t('Edit')) ?>" class="action"><img class="svg action" src="<?php echo OCP\Util::imagePath('core', 'actions/rename.svg') ?>"></a>
  <?php } ?>
</td>
<td width="20px">
