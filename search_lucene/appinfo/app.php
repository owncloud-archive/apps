...
OC::$CLASSPATH['OC_Search_Lucene'] = 'search_lucene/lib/lucene.php';
OC::$CLASSPATH['OC_Search_Lucene_Indexer'] = 'search_lucene/lib/indexer.php';
OC::$CLASSPATH['OC_Search_Lucene_Hooks'] = 'search_lucene/lib/hooks.php';
