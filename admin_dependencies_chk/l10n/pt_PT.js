OC.L10N.register(
    ...
    {
    "The php-json module is needed by the many applications for inter communications" : "O módulo php-json é necessário por diversas aplicações para intercomunicação",
    ...
    "The php-bcmath module is needed to support AD primary groups" : "É necessário o modulo php-bcmath para suportar grupos principais AD",
    "The php-zip module is needed to download multiple files at once" : "O módulo php-zip é necessário para descarregar vários ficheiros em simultâneo ",
    ...
    "The iconv module is needed to convert data into the correct charset." : "O módulo iconv é utilizado para converter dados para o charset correcto.",
