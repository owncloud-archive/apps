OC.L10N.register(
    ...
    "The php-ldap module is needed connect to your ldap server" : "php-ldapモジュールはLDAPサーバーへの接続に必要です",
    "The php-bcmath module is needed to support AD primary groups" : "php-bcmath モジュールはADプライマリグループのサポートに必要です",
    "The php-zip module is needed to download multiple files at once" : "php-zip モジュールは複数ファイルの同時ダウンロードに必要です",
