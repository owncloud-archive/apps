OC.L10N.register(
    ...
    "The php-bcmath module is needed to support AD primary groups" : "php-bcmath模块用于支持AD核心群",
    "The php-zip module is needed to download multiple files at once" : "php-zip模块用于同时下载多份文件",
