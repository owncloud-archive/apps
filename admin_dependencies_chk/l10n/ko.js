OC.L10N.register(
    ...
    "The php-bcmath module is needed to support AD primary groups" : "php-bcmath 모듈은 AD 주 그룹을 지원하는 데 필요합니다",
    "The php-zip module is needed to download multiple files at once" : "php-zip 모듈은 여러 파일을 한 번에 다운로드할 때 필요합니다",
