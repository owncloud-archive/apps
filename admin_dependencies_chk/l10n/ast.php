...
"The php-json module is needed by the many applications for inter communications" => "Ye necesariu'l módulu php-json por milenta aplicaciones pa comunicaciones inter",
...
"The php-zip module is needed download multiple files at once" => "Ye necesariu'l módulu php-zip pa baxar múltiples ficheros darréu",
...
"The allow_url_fopen directive of your php.ini should be set to 1 to retrieve knowledge base from OCS servers" => "La direutiva allow_url_fopen del to php.ini debería d'afitase a 1 pa recibir la base de conocimientu de los sirvidores OCS",
