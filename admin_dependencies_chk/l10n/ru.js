OC.L10N.register(
    ...
    "The php-zip module is needed to download multiple files at once" : "Для скачивания нескольких файлов за раз необходим модуль php-zip",
    ...
    "The php-xml module is needed to share files with webdav." : "Что-бы делиться файлами через webdav, необходим модуль php-xml.",
    "The allow_url_fopen directive of your php.ini should be set to 1 to retrieve knowledge base from OCS servers" : "Параметр allow_url_fopen в файле php.ini должен иметь значение 1 для получения базы знаний с серверов OCS",
    ...
    "The iconv module is needed to convert data into the correct charset." : "Модуль iconv необходим для преобразования данных в правильную кодировку",
