...
"The allow_url_fopen directive of your php.ini should be set to 1 to retrieve knowledge base from OCS servers" => " php.ini ფაილის allow_url_fopen დირექტივა უნდა იყოს 1–იანზე დაყენებული იმისათვის რომ მოხდეს ინფორმაციის მიღება OCS სერვერებიდან",
"The php-pdo module is needed to store owncloud data into a database." => " php-pdo მოდული არის საჭირო იმისათვირ ომ მოხდეს owncloud ინფორმაციის მონაცემთა ბაზაში შენახვა.",
"The iconv module is needed to convert data into the correct charset." => " iconv მოდული არის საჭირო ინფორმაციის კონვერტირებისათვის კორექტულ კოდირებაში.",
