...
"The php-curl modude is needed to fetch the page title when adding a bookmarks" => "El módulo php-curl se necesita para obtener el título de la página cuando se añade un marcador",
