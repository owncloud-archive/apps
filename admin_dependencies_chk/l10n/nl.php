...
"The php-curl modude is needed to fetch the page title when adding a bookmarks" => "De php-culr module is nodig voor het ophalen van de pagina titel wanneer bladwijzers worden toegevoegd",
