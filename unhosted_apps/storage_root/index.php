...
$requiredOrigin = OCP\Config::getSystemValue( "storage_origin", '' );//set the storage origin to something else than the owncloud admin interface origin to avoid xss vulnz.
