...
"Upgrade is not possible. Make sure that your webserver has write access to the following files and directories:" => "Eine Aktualisierung ist nicht möglich. Stellen Sie sicher, dass Ihr Webserver Schreibrechte auf die folgenden Dateien und Verzeichnisse hat:",
"Version not found" => "Version nicht gefunden",
"Upgrade is not possible. Your webserver has not enough permissions to remove the following directory:" => "Eine Aktualisierung ist nicht möglich. Ihr Webserver hat keine ausreichende Berechtigung zum Löschen des nachfolgenden Verzeichnisses:",
...
"Failed to create backup" => "Es ist ein Fehler beim Erstellen des Backups aufgetreten.",
