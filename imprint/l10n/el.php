...
"The content of the legal notice has to be configured first" => "Αρχικά πρέπει να διαμορφώσετε τα στοιχεία της ανακοίνωσης νομικού περιεχομένου",
"That configuration is done in the administration section." => "Η διαμόρφωση γίνεται στο τμήμα διοίκησης.",
"That configuration has to be done by the system administration." => "Η διαμόρφωση πρέπει να γίνει από τη διοίκηση του συστήματος. ",
"Imprint" => "Αποτύπωμα",
