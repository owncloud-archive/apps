...
"Standalone app" => "Отдельное приложение",
...
"Content" => "Содержание",
"You can use html markup (e.g. &lt;br&gt; for a linebreak) and inline style attributes (e.g. &lt;a style=\"color:red;\"&gt;)." => "Вы можете использовать html тэги (например, &lt;br&gt;), а также атрибуты стилей (например, &lt;a style=\"color:red;\"&gt;)"
);
