...
"Error (de)activating addressbook." => "Galat saat mengaktifkan/menonaktifkan buku alamat.",
"id is not set." => "id tidak disetel.",
"Cannot update addressbook with an empty name." => "Tidak dapat memperbarui buku alamat tanpa mengisi nama.",
"No category name given." => "Tidak ada kategori yang diberikan.",
...
"No ID provided" => "Tidak ada ID ditentukan",
"Error setting checksum." => "Galat saat menyetel checksum.",
"No categories selected for deletion." => "Tidak ada kategori terpilih untuk dihapus.",
"No address books found." => "Tidak ada buku alamat ditemukan.",
"No contacts found." => "Kontak tidak ditemukan",
"You have no addressbooks." => "Anda tidak punya buku alamat.",
"element name is not set." => "nama elemen tidak disetel.",
"checksum is not set." => "checksum tidak disetel.",
"Information about vCard is incorrect. Please reload the page." => "Informasi tentang vCard salah. Mohon muat ulang halaman.",
"Couldn't find vCard for %d." => "Tidak dapat menemukan vCard untuk %d.",
"Information about vCard is incorrect. Please reload the page: " => "Informasi tentang vCard salah. Mohon muat ulang halaman.",
"Something went FUBAR. " => "Ups. Ada kekacauan.",
"Cannot save property of type \"%s\" as array" => "Tidak dapat menyimpan properti tipe \"%s\" sebagai array.",
"Missing IM parameter." => "Parameter IM tidak ada.",
"Unknown IM: " => "IM tidak dikenal:",
"No contact ID was submitted." => "Tidak ada ID kontak yang dikirimkan.",
...
"Contact ID is missing." => "ID Kontak tidak ada.",
...
"The address book name cannot be empty." => "Nama buku alamat tidak boleh kosong.",
"Is this correct?" => "Sudah benar?",
"There was an unknown error when trying to delete this contact" => "Galat tak dikenal terjadi saat mencoba menghapus kontak ini",
"# groups" => "# grup",
...
"More..." => "Lainnya...",
"Less..." => "Ciutkan",
"You do not have the permissions to read this addressbook." => "Anda tidak memiliki izin untuk membaca buku alamat ini.",
"You do not have the permissions to update this addressbook." => "Anda tidak memiliki izin untuk memperbarui buku alamat ini.",
"There was an error updating the addressbook." => "Galat terjadi saat memperbarui buku alamat.",
"You do not have the permissions to delete this addressbook." => "Anda tidak memiliki izin untuk menghapus buku alamat ini.",
...
"Contact" => "Kontak",
"You do not have the permissions to add contacts to this addressbook." => "Anda tidak memiliki izin untuk menambahkan kontak ke buku alamat ini.",
"Could not find the vCard with ID." => "Tidak dapat menemukan vCard berdasarkan ID.",
"You do not have the permissions to edit this contact." => "Anda tidak memiliki izin untuk mengedit kontak ini.",
"Could not find the vCard with ID: " => "Tidak dapat menemukan vCard dengan ID:",
"Could not find the Addressbook with ID: " => "Tidak dapat menemukan Buku alamat dengan ID:",
"You do not have the permissions to delete this contact." => "Anda tidak memiliki izin untuk menghapus kontak ini.",
"There was an error deleting this contact." => "Galat terjadi saat menghapus kontak ini.",
...
"Download Contact(s)" => "Unduh Kontak",
"Groups" => "Grup",
"Favorite" => "Favorit",
