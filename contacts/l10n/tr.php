...
"No contact info was submitted." => "Hic bir enformasyon gonderildi",
...
"Merge failed. Cannot find contact: {id}" => "Birlikme basarmadi. Id munasebet bulmak edeme",
"Merge failed." => "Birleme olmadi ",
"Merge failed. Error saving contact." => "Birlikme olmadi. Itiraf hatali",
