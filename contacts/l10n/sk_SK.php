...
"No contact info was submitted." => "Neboli odoslané žiadne informácie o kontakte.",
...
"Failed saving sort order: {error}" => "Zlyhalo uloženie zoradenia: {error}",
"Failed saving last group: {error}" => "Zlyhalo uloženie poslednej skupiny: {error}",
...
"Failed deleting group: {error}" => "Zlyhalo zmazanie skupiny: {error}",
...
"Failed adding group: {error}" => "Zlyhalo pridanie skupiny: {error}",
"All" => "Všetky",
"Favorites" => "Obľúbené",
...
"Couldn't find contact." => "Kontakt nemožno nájsť.",
"Error merging into contact." => "Chyba pri zlučovaní do kontaktu.",
"Error saving contact to backend." => "Chyba pri ukladaní kontaktu do backendu.",
...
"Error saving property to backend" => "Chyba pri ukladaní údaja v backende.",
...
"Which contact should the data be merged into?" => "Do ktorého kontaktu si želáte zlúčiť dáta?",
