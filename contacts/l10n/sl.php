...
"No category name given." => "Ime kategorije ni podano.",
...
"No address books found." => "Ni mogoče najti imenika.",
...
"Couldn't find vCard for %d." => "Ni mogoče najti vCard za %d.",
...
"Cannot save property of type \"%s\" as array" => "Lastnosti vrste \"%s\" ni mogoče shraniti kot podatkovno polje",
...
"Enter name" => "Vnos imena",
"Enter description" => "Vnos opisa",
"Select addressbook" => "Izbor imenika",
"The address book name cannot be empty." => "Imenik mora imeti določeno ime.",
...
"Download Contact(s)" => "Prejmi seznam stikov",
"Groups" => "Skupine",
