...
"You have no addressbooks." => "شما هیچ  کتابچه آدرسی ندارید",
...
"Select addressbook" => "انتخاب کتابچه آدرس",
...
"Contact" => "اشخاص",
"You do not have the permissions to edit this contact." => "شما دسترسی لازم برای ویرایش این تماس را ندارید .",
"Contact not found." => "تماس یافت نشد",
"New Group" => "گروه جدید",
"Settings" => "تنظیمات",
"New" => "جدید",
"OK" => "باشه",
