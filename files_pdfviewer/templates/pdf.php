...
<head>
	...
	<script type="text/javascript" src="<?php print_unescaped(OC_Helper::linkTo('files_pdfviewer', '3rdparty/pdfjs/pdf.combined.js')); ?>"></script>
	...
	<script type="text/javascript" src="<?php print_unescaped(OC_Helper::linkTo('files_pdfviewer', '3rdparty/pdfjs/debugger.js')); ?>"></script>
