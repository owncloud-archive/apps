<form id="export" action="#" method="post">
    <fieldset class="personalblock">
        ...
        <p>
        <input type="radio" id="export_instance" name="export_type" value="instance" style="width:20px;" /><label for="export_instance"><?php echo $l->t('ownCloud instance (suitable for import)');?></label><br />
