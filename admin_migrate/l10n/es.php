...
"Please choose the export type:" => "Por favor elegir el tipo de exportación:",
"ownCloud instance (user data and database" => "instancia de ownCloud (datos de usuario y base de datos",
"ownCloud system files" => "Archivos de sistema de ownCloud",
"Just user files" => "Sólo archivos de usuario",
"Export" => "Exportar"
);
